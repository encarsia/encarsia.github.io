...
BLOG_AUTHOR = "Anke (encarsia)"  # (translatable)
BLOG_TITLE = "Merge and Destroy"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://encarsia.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://encarsia.github.io/"
BLOG_EMAIL = "An.Ke@bahnfreikartoffelbrei.de"
BLOG_DESCRIPTION = "Gute Absichten"  # (translatable)
